...
class mos extends StatefulWidget {
  const mos({Key? key}) : super(key: key);

  @override
  State<mos> createState() => _mosState();
}

class _mosState extends State<mos> {
  List Doctors=[];
            ...
            Card(
              ...
              child: SizedBox(
                ...
                child: ListTile(
                  ...
                  title: Text('DR.${Doctors[0]['name']}',style: TextStyle(fontWeight: FontWeight.bold),),
                  subtitle: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Row(children: [Icon(Icons.star_half_outlined,color: Colors.blue,),Text('reviews')],),
                      SizedBox(height: 5,),
                      Text('Ears And Nose- Minya hospital'),
                    ],
                  ),
            ...
            Card(
              ...
              child: SizedBox(
                ...
                child: ListTile(
                  ...
                  subtitle: Text('Dr.${Doctors[0]['name']} is one of the most well known doctors in his specialist.he achieved alot of awards for his wonderful contribution in medical field'),
