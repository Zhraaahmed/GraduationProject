...
class rof extends StatefulWidget {
  const rof({Key? key}) : super(key: key);

  @override
  State<rof> createState() => _rofState();
}

class _rofState extends State<rof> {
  List Doctors=[];
            ...
            Card(
              ...
              child: SizedBox(
                ...
                child: ListTile(
                  leading:Container(
                    height: 90,
                    child: Image(image:AssetImage('Images/7.jpg'),),
                  ),

                  title: Text('DR.${Doctors[5]['name']}',style: TextStyle(fontWeight: FontWeight.bold),),
                  subtitle: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Row(children: [Icon(Icons.star_half_outlined,color: Colors.blue,),Text('reviews')],),
                      SizedBox(height: 5,),
                      Text('general and plastic surgery - Minia hospital'),
                    ],
                  ),
            ...
            Card(
              ...
              child: SizedBox(
                ...
                child: ListTile(
                  ...
                  subtitle: Text('Dr.${Doctors[5]['name']} one of the most well known doctors in her specialist.she achieved alot of awards for her wonderful contribution in medical field'),
