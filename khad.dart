...
class kh extends StatefulWidget {
  const kh({Key? key}) : super(key: key);

  @override
  State<kh> createState() => _khState();
}

class _khState extends State<kh> {
  List Doctors=[];
            ...
            Card(
              ...
              child: SizedBox(
                ...
                child: ListTile(
                  ...
                  title: Text('DR.${Doctors[2]['name']}',style: TextStyle(fontWeight: FontWeight.bold),),
                  subtitle: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Row(children: [Icon(Icons.star_half_outlined,color: Colors.blue,),Text('reviews')],),
                      SizedBox(height: 5,),
                      Text('Ears And Nose Speciality - Minya hospital'),
                    ],
                  ),
            ...
            Card(
              ...
              child: SizedBox(
                ...
                child: ListTile(
                  ...
                  subtitle: Text('Dr.${Doctors[8]['name']} is one of the most well known doctors in her specialist.he achieved alot of awards for his wonderful contribution in medical field'),
