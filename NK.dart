...
class NK extends StatefulWidget {
  const NK({Key? key}) : super(key: key);

  @override
  State<NK> createState() => _NKState();
}

class _NKState extends State<NK> {
  List users=[];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: Center(
              child: Text("Weekly Report Of Nesma",
                  style: TextStyle(
